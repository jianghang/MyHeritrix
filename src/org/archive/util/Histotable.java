...
public class Histotable<K> extends HashMap<K,Long> {    
    ...
    public TreeSet getSortedByCounts() {
        // sorted by count
        TreeSet<Entry<K,Long>> sorted =
          new TreeSet<Entry<K,Long>>(
           new Comparator<Entry<K,Long>>() {
            public int compare(Entry<K,Long> e1,
                    Entry<K,Long> e2) {
                ...
                String firstKey = (String) ((Entry) e1).getKey();
                String secondKey = (String) ((Entry) e2).getKey();
